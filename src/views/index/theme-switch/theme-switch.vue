...
export default {
    ...
    methods: {
        setTheme(themeFile) {
            ...
            const userName = Cookies.get('nftUser');
            ...
            const stylePath = './src/views/index/theme-switch/theme/'
    ...
    created() {
        const path = './src/views/index/theme-switch/theme/'
        // if (config.env.indexOf('dev') > -1) {
        //     path = './src/views/main-components/theme-switch/theme/';
        // } else {
        //     path = 'dist/';
        // }
        const name = Cookies.get('nftUser');
        if (localStorage.theme) {
